...
public class SubscriptionYearlyPowerHouse extends BaseClass {
	...
	public void setup() throws IOException {
		...
		extentHtmlReporter = new ExtentHtmlReporter("SubscriptionYearlyPowerHousePack.html");
	...
	public void confirmPage() throws IOException {
		...
		SubscriptionPage module = PageFactory.initElements(driver, SubscriptionPage.class);
		module.subscriptionFlow("Annual");
		module.subscriptionFlow("PowerHouse");
		String modulePage = module.labelValidation("PowerHousePlan");
		extentTest.log(Status.INFO, "Actual Result is -" + modulePage);
	...
	public void billingInformationAmount() throws IOException {
		...
		SubscriptionPage module = PageFactory.initElements(driver, SubscriptionPage.class);
		String value = module.getValue("YearlyBillingAmount");
		extentTest.log(Status.INFO, "Actual Result is -" + value);
		extentTest.log(Status.INFO, "Expected Result is -" + SubscriptionPage.valueOf + " / Year");
		extentTest.log(Status.INFO, "Verification of Actual & Expected Validation");
		if (value.equals(SubscriptionPage.valueOf + " / Year")) {
			extentTest.log(Status.PASS, "Actual & Expected Validation are Equal");
		} else {
			extentTest.log(Status.FAIL, "Actual & Expected Validation are Not are Equal");
			TakesScreenshot screenshot = (TakesScreenshot) driver;
