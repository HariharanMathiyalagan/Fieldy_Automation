...
public class FieldyPrefixSettings extends BaseClass {
	...
	private void errorMessageforMaxValidation() throws AWTException, InterruptedException, IOException {
		extentTest = extentReports.createTest("Verify the Error Message Displayed For Job Field have more than 45 characters");
		PrefixSettingPage edit = PageFactory.initElements(driver, PrefixSettingPage.class);
        edit.clearField("JobPrefix");
        edit.enterJobPrefix();
        edit.clickSubmit();
