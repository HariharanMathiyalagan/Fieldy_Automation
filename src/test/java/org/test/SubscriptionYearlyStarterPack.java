...
public class SubscriptionYearlyStarterPack extends BaseClass {
	...
	public void setup() throws IOException {
		...
		extentHtmlReporter = new ExtentHtmlReporter("SubscriptionYearlyStarterPack.html");
	...
	public void confirmPage() throws IOException {
		...
		String modulePage = module.labelValidation("StarterPlan");
		extentTest.log(Status.INFO, "Actual Result is -" + modulePage);
