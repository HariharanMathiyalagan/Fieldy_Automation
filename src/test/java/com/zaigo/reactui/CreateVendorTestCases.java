...
public class CreateVendorTestCases {
	...
	/*
	 * 
	 * @Test (priority=12) public void verifyDuplicateEmail() throws
	 * InterruptedException { //Verify the Error Message if the email field is Null
	 * 
	 * 
	 * CreateVendorPage vendorPage = new CreateVendorPage(this.driver);
	 * vendorPage.dashBoardUserMenu(); vendorPage.clickVendorTab();
	 * vendorPage.vendorCreateButton(); vendorPage.clickNextButton();
	 * vendorPage.vendorName("sxxx"); vendorPage.vendorContactPerson("c name");
	 * vendorPage.vendorEmail("email@gmail.com"); vendorPage.clickSaveandComplete();
	 * String text =vendorPage.vendorEmailError(); Assert.assertEquals(text,
	 * "Email already Exists"); vendorPage.clickCloseButton();
	 * vendorPage.clickYesButton();
	 * 
	 * 
	 * }
...
//	}
	 ...
	 * 
	 * 
	 * @Test (priority=20) public void verifyVendorDeleted() throws
	 * InterruptedException { //Vendor Deleted successfully
	 * 
	 * CreateVendorPage vendorPage = new CreateVendorPage(this.driver);
	 * vendorPage.dashBoardUserMenu(); vendorPage.clickVendorTab();
	 * vendorPage.clickActionMenu(); vendorPage.clickDeleteMenu(); String text
	 * =vendorPage.vendorSuccessMessage();
