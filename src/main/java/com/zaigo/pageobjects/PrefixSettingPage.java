...
//	By settings_business = By.xpath("//div[text()=' Business Settings ']");
	...
	By ErrorMessageInvoiceNameMandatory = By.xpath("//span[text()='The invoice_prefix is required']");

	By ErrorMessageInvoiceNameMax = By
			.xpath("//span[text()='The invoice prefix may not be greater than 45 characters.']");

	By ErrorMessageInvoiceNumMandatory = By.xpath("//span[text()='This invoice prefix number is required.']");
	...
	public String getSuccessMessage() {
		...
		String getErrorRequiredMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(SuccessMessage))
				.getText();
